class PatternFlow < Formula
  ...
  if OS.mac?
    url "https://github.com/DrRingo/pattern-flow/releases/download/v1.0.0/pattern-flow-macos.tar.gz"
    sha256 "FA01F24F668706CF203BC6233BDB816822258A1033D92E4C33747C40057DA7B0"
  elsif OS.linux?
    url "https://github.com/DrRingo/pattern-flow/releases/download/v1.0.0/pattern-flow-linux.tar.gz"
    sha256 "2C1D8E149C6CDA0E7779EB705B2B21D5EDF1506892307BEBF34B44E3BAF062577"
  end
